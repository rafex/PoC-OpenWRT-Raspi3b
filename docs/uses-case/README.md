...
| Reinstalacion limpia despues de `apk upgrade` y reconstruccion de extroot | [examples/clean-reinstall-and-extroot-after-apk-upgrade.md](examples/clean-reinstall-and-extroot-after-apk-upgrade.md) |
